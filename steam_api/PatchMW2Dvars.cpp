...
void ServerCommand_SetClientDvarHook(char* name, char* value)
{
	...
	/*
	if ((*g_cheats)->current.boolean && !devmap && *demoPlaying != 1)
	{
		Com_Error(1, "sv_cheats is cheat protected!");
	}
	*/
...
void PatchMW2_Dvars()
{
	...
	*(BYTE*)0x4BA2B0 = 0xC3;
	...
	// un-protect r_fullbright
	*(BYTE*)0x519887 ^= DVAR_FLAG_CHEAT;
