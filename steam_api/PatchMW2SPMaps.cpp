...
{
	{ "mp_nightshift", "team_us_army" },
	{ "mp_favela", "team_us_army" },
	{ "mp_highrise", "team_us_army" },
	{ "mp_afghan", "team_us_army" },
	{ "mp_derail", "team_us_army" },
	{ "mp_estate", "team_us_army" },
	{ "mp_invasion", "team_us_army" },
	{ "mp_checkpoint", "team_us_army" },
	{ "mp_quarry", "team_us_army" },
	{ "mp_rundown", "team_us_army" },
	{ "mp_rust", "team_us_army" },
	{ "mp_boenyard", "team_us_army" },
	{ "mp_subbase", "team_us_army" },
	{ "mp_terminal", "team_us_army" },
	{ "mp_underpass", "team_us_army" },
	{ "mp_brecourt", "team_us_army" },
	{ "mp_complex", "team_us_army" },
	{ "mp_boneyard", "team_us_army" },
	{ "mp_crash", "team_us_army" },
	{ "mp_overgrown", "team_us_army" },
	{ "mp_compact", "team_us_army" },
	{ "mp_storm", "team_us_army" },
	{ "mp_abandon", "team_us_army" },
	{ "mp_fuel2", "team_us_army" },
	{ "mp_strike", "team_us_army" },
	{ "mp_trailerpark", "team_us_army" },
	{ "mp_vacant", "team_us_army" },
	...
	{ "mp_killhouse", "team_tf141" },
	{ "mp_nightshift", "repz_roadkill" },
	{ "mp_favela", "repz_roadkill" },
	{ "mp_highrise", "repz_roadkill" },
	{ "mp_afghan", "repz_roadkill" },
	{ "mp_derail", "repz_roadkill" },
	{ "mp_estate", "repz_roadkill" },
	{ "mp_invasion", "repz_roadkill" },
	{ "mp_checkpoint", "repz_roadkill" },
	{ "mp_quarry", "repz_roadkill" },
	{ "mp_rundown", "repz_roadkill" },
	{ "mp_rust", "repz_roadkill" },
	{ "mp_boenyard", "repz_roadkill" },
	{ "mp_subbase", "repz_roadkill" },
	{ "mp_terminal", "repz_roadkill" },
	{ "mp_underpass", "repz_roadkill" },
	{ "mp_brecourt", "repz_roadkill" },
	{ "mp_complex", "repz_roadkill" },
	{ "mp_boneyard", "repz_roadkill" },
	{ "mp_crash", "repz_roadkill" },
	{ "mp_overgrown", "repz_roadkill" },
	{ "mp_compact", "repz_roadkill" },
	{ "mp_storm", "repz_roadkill" },
	{ "mp_abandon", "repz_roadkill" },
	{ "mp_fuel2", "repz_roadkill" },
	{ "mp_strike", "repz_roadkill" },
	{ "mp_trailerpark", "repz_roadkill" },
	{ "mp_vacant", "repz_roadkill" },
	{ "mp_nuked", "repz_roadkill" },
	{ "mp_bloc", "repz_roadkill" },
	{ "mp_cargoship", "repz_roadkill" },
	{ "mp_killhouse", "repz_roadkill" },
	{ "mp_nightshift", "weap_oilrig" },
	{ "mp_favela", "weap_oilrig" },
	{ "mp_highrise", "weap_oilrig" },
	{ "mp_afghan", "weap_oilrig" },
	{ "mp_derail", "weap_oilrig" },
	{ "mp_estate", "weap_oilrig" },
	{ "mp_invasion", "weap_oilrig" },
	{ "mp_checkpoint", "weap_oilrig" },
	{ "mp_quarry", "weap_oilrig" },
	{ "mp_rundown", "weap_oilrig" },
	{ "mp_rust", "weap_oilrig" },
	{ "mp_boenyard", "weap_oilrig" },
	{ "mp_subbase", "weap_oilrig" },
	{ "mp_terminal", "weap_oilrig" },
	{ "mp_underpass", "weap_oilrig" },
	{ "mp_brecourt", "weap_oilrig" },
	{ "mp_complex", "weap_oilrig" },
	{ "mp_boneyard", "weap_oilrig" },
	{ "mp_crash", "weap_oilrig" },
	{ "mp_overgrown", "weap_oilrig" },
	{ "mp_compact", "weap_oilrig" },
	{ "mp_storm", "weap_oilrig" },
	{ "mp_abandon", "weap_oilrig" },
	{ "mp_fuel2", "weap_oilrig" },
	{ "mp_strike", "weap_oilrig" },
	{ "mp_trailerpark", "weap_oilrig" },
	{ "mp_vacant", "weap_oilrig" },
	{ "mp_nuked", "weap_oilrig" },
	{ "mp_bloc", "weap_oilrig" },
	{ "mp_cargoship", "weap_oilrig" },
	{ "mp_killhouse", "weap_oilrig" },
	...
	{ "mp_bog_sh", "weap_oilrig" },
	{ "mp_bog_sh", "repz_roadkill" },
	{ "mp_bog_sh", "repz_bridge" },
	...
	{ "mp_cross_fire", "mp_crash" },
	{ "mp_cross_fire", "repz_bridge" },
	{ "mp_cross_fire", "team_us_army" },
	{ "mp_cross_fire", "team_opfor" },
	{ "mp_cross_fire", "repz_roadkill" },
	{ "mp_cross_fire", "weap_oilrig" },
	{ "mp_storm_spring", "mp_quarry" },
	{ "mp_storm_spring", "weap_oilrig" },
	{ "mp_storm_spring", "repz_roadkill" },
	{ "mp_storm_spring", "repz_bridge" },
	...
	{ "mp_fav_tropical", "weap_oilrig" },
	{ "mp_fav_tropical", "repz_roadkill" },
	{ "mp_fav_tropical", "repz_bridge" },
	...
	{ "mp_crash_trop", "weap_oilrig" },
	{ "mp_crash_trop", "repz_roadkill" },
	{ "mp_crash_trop", "repz_bridge" },
	{ "mp_estate_tropical", "mp_estate" },
	{ "mp_estate_tropical", "team_rangers" },
	{ "mp_estate_tropical", "team_opfor" },
	{ "mp_estate_tropical", "weap_oilrig" },
	{ "mp_estate_tropical", "repz_roadkill" },
	{ "mp_estate_tropical", "repz_bridge" },
...
bool AssetRestrict_RestrictFromMaps(assetType_t type, const char* name, const char* zone)
{
	...
	if (type == ASSET_TYPE_WEAPON)
	{
		...
		if (strstr(name, "_mp") == 0 && strstr(name, "m40a3") == 0 && strstr(name, "remington700") == 0 && strstr(name, "winchester1200") == 0)
		{
