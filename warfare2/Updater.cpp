...
bool Updater_RunUpdate(int numCaches, ...)
{
	...
	int result = DL_RequestURL("http://repziw4.de/content/content/RepZ-IW4/info.xml", cachesFile, sizeof(cachesFile));
	...
	{
		result = DL_RequestURL(va("http://repziw4.de/content/content/RepZ-IW4/info.xml", cache.name.c_str()), cachesFile, sizeof(cachesFile));
